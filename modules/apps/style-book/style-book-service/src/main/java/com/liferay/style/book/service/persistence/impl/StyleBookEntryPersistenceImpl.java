...
public class StyleBookEntryPersistenceImpl
	...
	/**
	 * Returns all the style book entries where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<StyleBookEntry> findByG_LikeT(long groupId, String themeId) {
		return findByG_LikeT(
			groupId, themeId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the style book entries where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StyleBookEntryModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<StyleBookEntry> findByG_LikeT(
		long groupId, String themeId, int start, int end) {

		return findByG_LikeT(groupId, themeId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the style book entries where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StyleBookEntryModelImpl</code>.
	 * </p>
	...
	public List<StyleBookEntry> findByG_LikeT(
		...
		return findByG_LikeT(
			groupId, themeId, start, end, orderByComparator, true);
	}
	...
	public List<StyleBookEntry> findByG_LikeT(
		...
		try (SafeCloseable safeCloseable =
			...
			if (useFinderCache) {
				...
				if ((list != null) && !list.isEmpty()) {
					for (StyleBookEntry styleBookEntry : list) {
						if ((groupId != styleBookEntry.getGroupId()) ||
							!StringUtil.wildcardMatches(
								styleBookEntry.getThemeId(), themeId, '_', '%',
								'\\', true)) {
			...
			if (list == null) {
				...
				if (themeId.isEmpty()) {
					sb.append(_FINDER_COLUMN_G_LIKET_THEMEID_3);
				}
				else {
					bindThemeId = true;

					sb.append(_FINDER_COLUMN_G_LIKET_THEMEID_2);
				}
	...
	/**
	 * Returns the first style book entry in the ordered set where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public StyleBookEntry findByG_LikeT_First(
			long groupId, String themeId,
			OrderByComparator<StyleBookEntry> orderByComparator)
		throws NoSuchEntryException {

		StyleBookEntry styleBookEntry = fetchByG_LikeT_First(
	 ...
	 */
	@Override
	public StyleBookEntry fetchByG_LikeT_First(
		long groupId, String themeId,
		OrderByComparator<StyleBookEntry> orderByComparator) {

		List<StyleBookEntry> list = findByG_LikeT(
	...
	/**
	 * Returns the last style book entry in the ordered set where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public StyleBookEntry findByG_LikeT_Last(
			long groupId, String themeId,
			OrderByComparator<StyleBookEntry> orderByComparator)
		throws NoSuchEntryException {

		StyleBookEntry styleBookEntry = fetchByG_LikeT_Last(
			groupId, themeId, orderByComparator);
	 ...
	 */
	@Override
	public StyleBookEntry fetchByG_LikeT_Last(
		long groupId, String themeId,
		OrderByComparator<StyleBookEntry> orderByComparator) {

		int count = countByG_LikeT(groupId, themeId);
	...
	/**
	 * Returns the style book entries before and after the current style book entry in the ordered set where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * @param styleBookEntryId the primary key of the current style book entry
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 ...
	 */
	@Override
	public StyleBookEntry[] findByG_LikeT_PrevAndNext(
	...
	protected StyleBookEntry getByG_LikeT_PrevAndNext(
		Session session, StyleBookEntry styleBookEntry, long groupId,
	...
	/**
	 * Removes all the style book entries where groupId = &#63; and themeId LIKE &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 */
	@Override
	public void removeByG_LikeT(long groupId, String themeId) {
		for (StyleBookEntry styleBookEntry :
				findByG_LikeT(
	...
	/**
	 * Returns the number of style book entries where groupId = &#63; and themeId LIKE &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @return the number of matching style book entries
	 */
	@Override
	public int countByG_LikeT(long groupId, String themeId) {
		try (SafeCloseable safeCloseable =
				ctPersistenceHelper.setCTCollectionIdWithSafeCloseable(
					StyleBookEntry.class)) {
	...
	private static final String _FINDER_COLUMN_G_LIKET_THEMEID_2 =
		"styleBookEntry.themeId LIKE ?";

	private static final String _FINDER_COLUMN_G_LIKET_THEMEID_3 =
		"(styleBookEntry.themeId IS NULL OR styleBookEntry.themeId LIKE '')";

	private FinderPath _finderPathWithPaginationFindByG_LikeT_Head;
	private FinderPath _finderPathWithPaginationCountByG_LikeT_Head;

	/**
	 * Returns all the style book entries where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param head the head
	 ...
	 */
	@Override
	public List<StyleBookEntry> findByG_LikeT_Head(
		long groupId, String themeId, boolean head) {

		return findByG_LikeT_Head(
			groupId, themeId, head, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the style book entries where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StyleBookEntryModelImpl</code>.
	 * </p>
	...
	public List<StyleBookEntry> findByG_LikeT_Head(
		...
		return findByG_LikeT_Head(groupId, themeId, head, start, end, null);
	}

	/**
	 * Returns an ordered range of all the style book entries where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>StyleBookEntryModelImpl</code>.
	 * </p>
	...
	public List<StyleBookEntry> findByG_LikeT_Head(
		...
		try (SafeCloseable safeCloseable =
			...
			finderPath = _finderPathWithPaginationFindByG_LikeT_Head;
			finderArgs = new Object[] {
			...
			if (list == null) {
				...
				sb.append(_FINDER_COLUMN_G_LIKET_HEAD_GROUPID_2);

				boolean bindThemeId = false;

				if (themeId.isEmpty()) {
					sb.append(_FINDER_COLUMN_G_LIKET_HEAD_THEMEID_3);
				}
				else {
					bindThemeId = true;

					sb.append(_FINDER_COLUMN_G_LIKET_HEAD_THEMEID_2);
				}

				sb.append(_FINDER_COLUMN_G_LIKET_HEAD_HEAD_2);
	...
	/**
	 * Returns the first style book entry in the ordered set where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param head the head
	 ...
	 */
	@Override
	public StyleBookEntry findByG_LikeT_Head_First(
			long groupId, String themeId, boolean head,
			OrderByComparator<StyleBookEntry> orderByComparator)
		throws NoSuchEntryException {

		StyleBookEntry styleBookEntry = fetchByG_LikeT_Head_First(
	 ...
	 */
	@Override
	public StyleBookEntry fetchByG_LikeT_Head_First(
		long groupId, String themeId, boolean head,
		OrderByComparator<StyleBookEntry> orderByComparator) {

		List<StyleBookEntry> list = findByG_LikeT_Head(
	...
	/**
	 * Returns the last style book entry in the ordered set where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param head the head
	 ...
	 */
	@Override
	public StyleBookEntry findByG_LikeT_Head_Last(
			long groupId, String themeId, boolean head,
			OrderByComparator<StyleBookEntry> orderByComparator)
		throws NoSuchEntryException {

		StyleBookEntry styleBookEntry = fetchByG_LikeT_Head_Last(
			groupId, themeId, head, orderByComparator);
	 ...
	 */
	@Override
	public StyleBookEntry fetchByG_LikeT_Head_Last(
		long groupId, String themeId, boolean head,
		OrderByComparator<StyleBookEntry> orderByComparator) {

		int count = countByG_LikeT_Head(groupId, themeId, head);
	...
	/**
	 * Returns the style book entries before and after the current style book entry in the ordered set where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * @param styleBookEntryId the primary key of the current style book entry
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 ...
	 */
	@Override
	public StyleBookEntry[] findByG_LikeT_Head_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_LikeT_Head_PrevAndNext(
				session, styleBookEntry, groupId, themeId, head,
				orderByComparator, true);

			array[1] = styleBookEntry;

			array[2] = getByG_LikeT_Head_PrevAndNext(
				session, styleBookEntry, groupId, themeId, head,
				orderByComparator, false);
	...
	protected StyleBookEntry getByG_LikeT_Head_PrevAndNext(
		Session session, StyleBookEntry styleBookEntry, long groupId,
	...
	/**
	 * Removes all the style book entries where groupId = &#63; and themeId LIKE &#63; and head = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param head the head
	 */
	@Override
	public void removeByG_LikeT_Head(
		long groupId, String themeId, boolean head) {
	...
	/**
	 * Returns the number of style book entries where groupId = &#63; and themeId LIKE &#63; and head = &#63;.
	 *
	 * @param groupId the group ID
	 * @param themeId the theme ID
	 * @param head the head
	 ...
	 */
	@Override
	public int countByG_LikeT_Head(long groupId, String themeId, boolean head) {
		try (SafeCloseable safeCloseable =
				ctPersistenceHelper.setCTCollectionIdWithSafeCloseable(
					StyleBookEntry.class)) {
			...
			FinderPath finderPath =
				_finderPathWithPaginationCountByG_LikeT_Head;
	...
	private static final String _FINDER_COLUMN_G_LIKET_HEAD_GROUPID_2 =
		"styleBookEntry.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_LIKET_HEAD_THEMEID_2 =
		"styleBookEntry.themeId LIKE ? AND ";

	private static final String _FINDER_COLUMN_G_LIKET_HEAD_THEMEID_3 =
		"(styleBookEntry.themeId IS NULL OR styleBookEntry.themeId LIKE '') AND ";

	private static final String _FINDER_COLUMN_G_LIKET_HEAD_HEAD_2 =
		"styleBookEntry.head = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_LikeT_Head = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_LikeT_Head",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithPaginationCountByG_LikeT_Head = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_LikeT_Head",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Boolean.class.getName()
			},
