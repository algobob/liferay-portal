...
public class StyleBookEntryVersionPersistenceImpl
	...
	private FinderPath _finderPathWithoutPaginationFindByG_LikeT;
	private FinderPath _finderPathCountByG_LikeT;
	 ...
	 */
	@Override
	public List<StyleBookEntryVersion> findByG_LikeT(
	...
	public List<StyleBookEntryVersion> findByG_LikeT(
		...
		try (SafeCloseable safeCloseable =
			...
			if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				...
				if (useFinderCache) {
					finderPath = _finderPathWithoutPaginationFindByG_LikeT;
	 ...
	 */
	@Override
	public StyleBookEntryVersion findByG_LikeT_First(
			long groupId, String themeId,
			OrderByComparator<StyleBookEntryVersion> orderByComparator)
		throws NoSuchEntryVersionException {

		StyleBookEntryVersion styleBookEntryVersion = fetchByG_LikeT_First(
	 ...
	 */
	@Override
	public StyleBookEntryVersion fetchByG_LikeT_First(
		long groupId, String themeId,
		OrderByComparator<StyleBookEntryVersion> orderByComparator) {

		List<StyleBookEntryVersion> list = findByG_LikeT(
	 ...
	 */
	@Override
	public StyleBookEntryVersion findByG_LikeT_Last(
			long groupId, String themeId,
			OrderByComparator<StyleBookEntryVersion> orderByComparator)
		throws NoSuchEntryVersionException {

		StyleBookEntryVersion styleBookEntryVersion = fetchByG_LikeT_Last(
			groupId, themeId, orderByComparator);
	 ...
	 */
	@Override
	public StyleBookEntryVersion fetchByG_LikeT_Last(
		long groupId, String themeId,
		OrderByComparator<StyleBookEntryVersion> orderByComparator) {
	 ...
	 */
	@Override
	public StyleBookEntryVersion[] findByG_LikeT_PrevAndNext(
	...
	protected StyleBookEntryVersion getByG_LikeT_PrevAndNext(
		Session session, StyleBookEntryVersion styleBookEntryVersion,
		long groupId, String themeId,
		OrderByComparator<StyleBookEntryVersion> orderByComparator,
		boolean previous) {
	...
	public int countByG_LikeT(long groupId, String themeId) {
		try (SafeCloseable safeCloseable =
			...
			FinderPath finderPath = _finderPathCountByG_LikeT;
	...
	private FinderPath _finderPathWithPaginationFindByG_LikeT_Version;
	private FinderPath _finderPathWithoutPaginationFindByG_LikeT_Version;
	private FinderPath _finderPathCountByG_LikeT_Version;
	 ...
	 */
	@Override
	public List<StyleBookEntryVersion> findByG_LikeT_Version(
		long groupId, String themeId, int version) {

		return findByG_LikeT_Version(
	...
	public List<StyleBookEntryVersion> findByG_LikeT_Version(
		...
		return findByG_LikeT_Version(
			groupId, themeId, version, start, end, null);
	}
	...
	public List<StyleBookEntryVersion> findByG_LikeT_Version(
		...
		try (SafeCloseable safeCloseable =
			...
			if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				...
				if (useFinderCache) {
					finderPath =
						_finderPathWithoutPaginationFindByG_LikeT_Version;
					finderArgs = new Object[] {groupId, themeId, version};
				}
			}
			else if (useFinderCache) {
				finderPath = _finderPathWithPaginationFindByG_LikeT_Version;
				finderArgs = new Object[] {
			...
			if (list == null) {
				...
				sb.append(_FINDER_COLUMN_G_LIKET_VERSION_GROUPID_2);

				boolean bindThemeId = false;

				if (themeId.isEmpty()) {
					sb.append(_FINDER_COLUMN_G_LIKET_VERSION_THEMEID_3);
				}
				else {
					bindThemeId = true;

					sb.append(_FINDER_COLUMN_G_LIKET_VERSION_THEMEID_2);
				}

				sb.append(_FINDER_COLUMN_G_LIKET_VERSION_VERSION_2);
	 ...
	 */
	@Override
	public StyleBookEntryVersion findByG_LikeT_Version_First(
			long groupId, String themeId, int version,
			OrderByComparator<StyleBookEntryVersion> orderByComparator)
		throws NoSuchEntryVersionException {

		StyleBookEntryVersion styleBookEntryVersion =
			fetchByG_LikeT_Version_First(
	 ...
	 */
	@Override
	public StyleBookEntryVersion fetchByG_LikeT_Version_First(
		long groupId, String themeId, int version,
		OrderByComparator<StyleBookEntryVersion> orderByComparator) {

		List<StyleBookEntryVersion> list = findByG_LikeT_Version(
	 ...
	 */
	@Override
	public StyleBookEntryVersion findByG_LikeT_Version_Last(
			long groupId, String themeId, int version,
			OrderByComparator<StyleBookEntryVersion> orderByComparator)
		throws NoSuchEntryVersionException {

		StyleBookEntryVersion styleBookEntryVersion =
			fetchByG_LikeT_Version_Last(
				groupId, themeId, version, orderByComparator);
	 ...
	 */
	@Override
	public StyleBookEntryVersion fetchByG_LikeT_Version_Last(
		long groupId, String themeId, int version,
		OrderByComparator<StyleBookEntryVersion> orderByComparator) {

		int count = countByG_LikeT_Version(groupId, themeId, version);
	 ...
	 */
	@Override
	public StyleBookEntryVersion[] findByG_LikeT_Version_PrevAndNext(
			long styleBookEntryVersionId, long groupId, String themeId,
			int version,
			OrderByComparator<StyleBookEntryVersion> orderByComparator)
		throws NoSuchEntryVersionException {
		...
		try {
			...
			array[0] = getByG_LikeT_Version_PrevAndNext(
				session, styleBookEntryVersion, groupId, themeId, version,
				orderByComparator, true);

			array[1] = styleBookEntryVersion;

			array[2] = getByG_LikeT_Version_PrevAndNext(
				session, styleBookEntryVersion, groupId, themeId, version,
				orderByComparator, false);
	...
	protected StyleBookEntryVersion getByG_LikeT_Version_PrevAndNext(
		Session session, StyleBookEntryVersion styleBookEntryVersion,
		long groupId, String themeId, int version,
		OrderByComparator<StyleBookEntryVersion> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByG_LikeT_Version(
		long groupId, String themeId, int version) {

		for (StyleBookEntryVersion styleBookEntryVersion :
				findByG_LikeT_Version(
	 ...
	 */
	@Override
	public int countByG_LikeT_Version(
		long groupId, String themeId, int version) {
		...
		try (SafeCloseable safeCloseable =
			...
			FinderPath finderPath = _finderPathCountByG_LikeT_Version;
	...
	private static final String _FINDER_COLUMN_G_LIKET_VERSION_GROUPID_2 =
		"styleBookEntryVersion.groupId = ? AND ";

	private static final String _FINDER_COLUMN_G_LIKET_VERSION_THEMEID_2 =
		"styleBookEntryVersion.themeId = ? AND ";

	private static final String _FINDER_COLUMN_G_LIKET_VERSION_THEMEID_3 =
		"(styleBookEntryVersion.themeId IS NULL OR styleBookEntryVersion.themeId = '') AND ";

	private static final String _FINDER_COLUMN_G_LIKET_VERSION_VERSION_2 =
		"styleBookEntryVersion.version = ?";
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByG_LikeT = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_LikeT",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "themeId"}, true);

		_finderPathCountByG_LikeT = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_LikeT",
			new String[] {Long.class.getName(), String.class.getName()},
			new String[] {"groupId", "themeId"}, false);

		_finderPathWithPaginationFindByG_LikeT_Version = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_LikeT_Version",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
		...
		_finderPathWithoutPaginationFindByG_LikeT_Version = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_LikeT_Version",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Integer.class.getName()
			},
		...
		_finderPathCountByG_LikeT_Version = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_LikeT_Version",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Integer.class.getName()
			},
